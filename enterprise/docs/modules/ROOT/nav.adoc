...
**** xref:Technical Documentation/Payara Server Documentation/Server Configuration And Management/Configuration Options/Transaction Service.adoc[Transaction Service]
...
** xref:Technical Documentation/MicroProfile/JWT Caching.adoc[JWT Caching]
