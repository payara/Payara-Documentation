...
* 6.39.0
** xref:Jakarta EE Certification/6.39.0/6.39.0 Platform TCK Results.adoc[6.39.0 Platform TCK Results]
** xref:Jakarta EE Certification/6.39.0/6.39.0 (Web Profile) Web TCK Results.adoc[6.39.0 (Web Profile) Web TCK Results]
** xref:Jakarta EE Certification/6.39.0/6.39.0 Core TCK Results.adoc[6.39.0 Core TCK Results]
** xref:Jakarta EE Certification/6.39.0/6.39.0 (Web Profile) Core TCK Results.adoc[6.39.0 (Web Profile) Core TCK Results]
* 6.38.0
