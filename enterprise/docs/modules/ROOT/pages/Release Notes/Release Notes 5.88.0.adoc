...
== Behaviour Changes
The default (undefined) value of the `fish.payara.ready-after-applications` system property has changed from `false` to `true`, aligning Enterprise 5 with Community and Enterprise 7.
