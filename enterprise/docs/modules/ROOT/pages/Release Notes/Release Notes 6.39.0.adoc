...
== Component Upgrades
* [FISH-13408] Upgrade `jline.version` from 3.30.8 to 3.30.9
...
* [FISH-13578] Upgrade `asm.version` from 9.9.1 to 9.10
* [FISH-13579] Upgrade `jline.version` from 3.30.9 to 3.30.13
