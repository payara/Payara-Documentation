...
This may change the timing of post-boot scripts and transaction recovery. To restore the previous behaviour, set `fish.payara.ready-after-applications=false`.
