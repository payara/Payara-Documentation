...
== Payara Server 6.38.0-Test Jakarta EE 10 Platform Certification Summary
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 6.38.0-Test]
|===
...
+
https://docs.payara.fish/enterprise/docs/6.38.0-Test/Jakarta%20EE%20Certification/6.38.0-Test/6.38.0-Test%20Platform%20TCK%20Results.html[6.38.0-Test Platform TCK Results]
...
```
   Completed running 1833 tests.
   Number of Tests Passed      = 1833
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
```
...
```
   Completed running 5400 tests.
   Number of Tests Passed      = 5400
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
```
...
```
   Completed running 348 tests.
   Number of Tests Passed      = 242
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
   Number of Tests skipped     = 106
```
...
```
   Completed running 708 tests.
   Number of Tests Passed      = 708
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
```
...
```
   Completed running 2660 tests.
   Number of Tests Passed      = 2596
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
   Number of Tests skipped     = 64
```
