...
**Payara Server 5.48.1 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.48.1 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/Jakarta%20EE%20Certification/5.48.1/5.48.1%20Web%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 588.532 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,292.283 s - in TestSuite
 [mvn.test] [INFO]
