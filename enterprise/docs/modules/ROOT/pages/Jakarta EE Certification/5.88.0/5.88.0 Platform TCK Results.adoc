...
+
https://docs.payara.fish/enterprise/docs/Jakarta%20EE%20Certification/5.88.0/5.88.0%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 466.203 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,733.498 s - in TestSuite
 [mvn.test] [INFO]
...
```
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.057 sec
```
