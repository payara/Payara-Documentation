...
+
https://docs.payara.fish/enterprise/docs/Jakarta%20EE%20Certification/5.51.0/5.51.0%20Web%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 605.699 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,260.244 s - in TestSuite
 [mvn.test] [INFO]
...
```
   ...
   [runcts] OUT => [javatest.batch] Apr 12, 2023 3:16:10 AM Harness done with cleanup from test run.Number of Tests Passed      = 61
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
```
