...
**Payara Server 5.76.0 Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.76.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/Jakarta%20EE%20Certification/5.76.0/5.76.0%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 450.726 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.05 sec
```
### ejb
