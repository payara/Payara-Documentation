...
**Payara Server 5.38.0 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.38.0 (Web Profile)]
|===
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 683.66 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,536.046 s - in TestSuite
 [mvn.test] [INFO]
...
```
   ...
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 24
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
   [runcts] OUT => [javatest.batch] Completed running 24 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 0
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 24
