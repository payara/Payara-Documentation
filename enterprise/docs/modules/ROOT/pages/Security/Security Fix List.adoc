...
|https://nvd.nist.gov/vuln/detail/CVE-2023-41080[CVE-2023-41080] | 6.1 | FIXED | URL Redirection to Untrusted Site ('Open Redirect') vulnerability in FORM authentication feature on root context | 5.57.0, 4.1.2.191.46 | Fixed by porting fix from Apache Tomcat.
