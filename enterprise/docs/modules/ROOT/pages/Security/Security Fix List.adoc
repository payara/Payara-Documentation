...
|https://nvd.nist.gov/vuln/detail/CVE-2023-28462[CVE-2022-0265] | 9.8 | FIXED | Improper Restriction of XML External Entity Reference in GitHub repository hazelcast/hazelcast in 5.1-BETA-1.  ||| This can only be triggered if explicitly using hazelcast to parse XML data.
