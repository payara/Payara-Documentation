...
|https://www.cve.org/CVERecord?id=CVE-2024-9408[CVE-2024-9408] | 9.6 | FIXED | The admin console leaked the admin REST token to attacker-controlled hosts via an unvalidated restUrl parameter, enabling
