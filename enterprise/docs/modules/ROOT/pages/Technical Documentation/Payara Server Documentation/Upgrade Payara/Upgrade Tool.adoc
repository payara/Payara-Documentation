...
|`--nodes` |String |Names of the nodes to upgrade. Enables to upgrade nodes individually, to avoid downtime (see below for more details). Can have a list of nodes, separated by comma (eg *--nodes node1,node2*)Only available in v5.83.0 or v6.34.0 and above| |No
|=======================================================================
