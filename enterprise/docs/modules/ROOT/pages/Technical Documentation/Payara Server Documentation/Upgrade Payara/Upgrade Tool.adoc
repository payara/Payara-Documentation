...
|`--nodes` |String |The names of the nodes to upgrade. Allows the upgrading of nodes individually lowering potential downtime (See below for details). Supports single node or a comma separated list (e.g. --nodes node1,node2) Only available in v5.83.0 or v6.34.0 and above.| |No
|=======================================================================
