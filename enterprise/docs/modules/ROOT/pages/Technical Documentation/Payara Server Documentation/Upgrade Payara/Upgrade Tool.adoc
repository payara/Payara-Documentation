...
IMPORTANT: The Upgrade tool doesn't support migrating from Payara Server Enterprise 5.x installations to 6.x or from Payara Server Enterprise 6.x to newer minor releases +
Both upgrade paths will be implemented on a future release of the tool.
