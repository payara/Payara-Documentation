...
Payara Server Enterprise Edition allows plugin extensions to expand the features of the server's runtime. This extensions are not included in the default server's runtime and they must be installed before considering their usage.
