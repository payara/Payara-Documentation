...
In order to observe the events in an application, use the xref:Payara-Documentation/docs/modules/ROOT/pages/Technical Documentation/Public API/Overview.adoc[Payara API artifact] as a compile time dependency. 
