...
- link:https://nexus.payara.fish/repository/payara-enterprise-downloadable-artifacts/fish/payara/extensions/notifiers/datadog-notifier-console-plugin/2.0-enterprise-enterprise/datadog-notifier-console-plugin-2.0-enterprise-enterprise.jar[Datadog Notifier Console Plugin 2.0-enterprise]
