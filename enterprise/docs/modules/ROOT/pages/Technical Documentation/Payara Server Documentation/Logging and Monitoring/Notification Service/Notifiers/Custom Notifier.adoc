...
The notification service is fully modular, this design allows developers to create their custom Notifier and plug it in into the Payara Platform. This guide describes how to create your Notifier.
