...
¦6.37.0 ¦6.38.0 a¦
----
In Linux, when starting the admin console for the upgraded domain:
[2026-05-06T16:00:06.805+0100] [Payara 6.38.0] [SEVERE] [AS-WEB-CORE-00108] [jakarta.enterprise.web.core] [tid: _ThreadID=137 _ThreadName=Thread-13] [timeMillis: 1778079606805] [levelValue: 1000] [[  ContainerBase.addChild: start: org.apache.catalina.LifecycleException: java.lang.IllegalStateException: CDI is not available
----
|=======================================================================