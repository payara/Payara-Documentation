...
Diagnostics can be collected directly from a remote DAS by specifying the admin port of the target instance (by using the `-p`|`--port` asadmin options), like this:
