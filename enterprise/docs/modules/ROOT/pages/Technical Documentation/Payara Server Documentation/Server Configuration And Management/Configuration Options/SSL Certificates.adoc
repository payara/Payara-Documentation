...
You can generate a self-signed certificate using the command detailed xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#generate-self-signed-certificate[here]
...
The resulting p12 bundle can then be add to the keystore and truststore in Payara Server as described in the following sections.
...
You can use the `add-to-keystore` asadmin command, detailed xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#add-to-keystore[here].
...
You can use the `add-to-truststore` asadmin command, detailed xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#add-to-truststore[here].
...
xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#remove-expired-certificates[here],
xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#remove-from-keystore[here], and
xref:Technical Documentation/Payara Server Documentation/Server Configuration  and Management/Integrated Certificate Management.adoc#remove-from-truststore[here] respectively.
