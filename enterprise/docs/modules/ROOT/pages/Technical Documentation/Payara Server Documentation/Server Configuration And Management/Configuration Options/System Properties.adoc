...
| fish.payara.ready-after-applications | boolean | This option determines when the server marks itself as "ready".
...
The behaviour in versions prior to Enterprise 5.47.0 aligned with `true`.
