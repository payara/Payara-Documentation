...
**Payara Server 5.88.0 Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.88.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/Eclipse%20MicroProfile%20Certification/5.88.0/Server%20Full%20TCK%20Results.html
...
```
   ...
   Number of Tests Passed      = 209
   Number of Tests Failed      = 0
   Number of Tests with Errors = 0
   Number of Tests skipped     = 11
```
