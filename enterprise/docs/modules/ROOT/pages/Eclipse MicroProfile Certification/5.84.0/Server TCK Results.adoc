...
**Payara Server 5.84.0 Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.84.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/Eclipse%20MicroProfile%20Certification/5.84.0/Server%20Full%20TCK%20Results.html
