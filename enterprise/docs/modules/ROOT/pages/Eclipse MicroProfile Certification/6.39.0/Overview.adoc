...
The following distributions of Payara 6.39.0 are certified, with results for each listed below:

* xref:Eclipse MicroProfile Certification/6.39.0/Server TCK Results.adoc[Payara Server 6.39.0]
* xref:Eclipse MicroProfile Certification/6.39.0/Server Web TCK Results.adoc[Payara Server 6.39.0 - Web Profile]
