...
The following distributions of Payara 5.87.0 are certified, with results for each listed below:

* xref:Eclipse MicroProfile Certification/5.87.0/Server TCK Results.adoc[Payara Server 5.87.0]
* xref:Eclipse MicroProfile Certification/5.87.0/Server Web TCK Results.adoc[Payara Server 5.87.0 - Web Profile]
