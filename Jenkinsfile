            ...
            script {
                ...
                if (prNumber) {
                    ...
                    def commentBody = "${commentMarker}\\n" +
                        ...
                        "Check that any new or modified pages are accurate, well-structured, and free of broken links or formatting issues.\\n\\n" +
                        "---\\n" +
                        "*Generated by Jenkins build [#${env.BUILD_NUMBER}](${env.BUILD_URL})*"
