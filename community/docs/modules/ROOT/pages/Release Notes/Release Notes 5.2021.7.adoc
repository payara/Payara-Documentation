...
We'd like to thank _Thibaud Kehler_ and _Oliver Maicher_ from SySS GmbH who reported this vulnerability to the Payara team via the security@payara.fish email address as instructed in xref:Security/Security.adoc#reporting-security-issues[Reporting Security Issues].
