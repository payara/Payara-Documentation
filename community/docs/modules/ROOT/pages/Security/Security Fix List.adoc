...
unauthenticated remote code execution. | 7.2026.6 | https://github.com/payara/Payara/pull/8229[#8229] | Fixed by replacing user-supplied
restUrl with a trusted server-side session attribute.
