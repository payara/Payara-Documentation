...
|https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-37422[CVE-2022-37422] | N/A | FIXED | Vulnerability exploit using ROOT context root deployments | 5.2022.2 | https://github.com/payara/Payara/pull/5886[#5886] | Recommended to immediately upgrade to this release if any of your applications is deployed on the / context root on Payara Server or Payara Micro
