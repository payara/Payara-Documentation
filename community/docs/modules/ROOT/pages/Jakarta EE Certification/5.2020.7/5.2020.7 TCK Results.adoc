...
**Payara Server 5.2020.7 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2020.7]
|===
...
+
https://docs.payara.fish/community/docs/5.2020.7/jakartaee-certification/5.2020.7/tck-results-full-5.2020.7.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 652.933 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,763.996 s - in TestSuite
 [mvn.test] [INFO] 
