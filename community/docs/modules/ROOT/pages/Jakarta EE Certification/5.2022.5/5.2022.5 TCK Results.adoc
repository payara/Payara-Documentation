...
**Payara Server 5.2022.5 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.5]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/5.2022.5/5.2022.5%20TCK%20Results.html
...
```
   [runcts] OUT => [javatest.batch] Dec 6, 2022 5:29:22 PM Finished executing all tests, wait for cleanup...Completed running 53 tests.
   [runcts] OUT => [javatest.batch]
   [runcts] OUT => [javatest.batch] Dec 6, 2022 5:29:22 PM Harness done with cleanup from test run.
