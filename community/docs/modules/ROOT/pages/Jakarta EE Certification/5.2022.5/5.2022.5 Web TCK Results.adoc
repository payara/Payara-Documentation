...
**Payara Server 5.2022.5 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.5 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/5.2022.5/5.2022.5%20Web%20TCK%20Results.html
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.074 sec
```
