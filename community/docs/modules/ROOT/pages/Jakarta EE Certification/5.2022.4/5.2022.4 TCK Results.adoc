...
**Payara Server 5.2022.4 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.4]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/5.2022.4/5.2022.4%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,124.916 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2,053.36 s - in TestSuite
 [mvn.test] [INFO]
...
```
   ...
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 492
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 3
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.106 sec
```
### ejb
