...
**Payara Server 5.2022.4 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.4 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/Jakarta%20EE%20Certification/5.2022.4/5.2022.4%20Web%20TCK%20Results.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 700.56 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,546.985 s - in TestSuite
 [mvn.test] [INFO]
