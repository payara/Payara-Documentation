...
**Payara Server 5.2022.2 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.2]
|===
...
+
https://docs.payara.fish/community/docs/5.2022.2/jakartaee-certification/5.2022.2/tck-results-full-5.2022.2.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 705.667 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2,026.567 s - in TestSuite
 [mvn.test] [INFO]
