...
**Payara Server 5.2022.3 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.3]
|===
...
+
https://docs.payara.fish/community/docs/5.2022.3/jakartaee-certification/5.2022.3/tck-results-full-5.2022.3.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 704.973 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 2,137.275 s - in TestSuite
 [mvn.test] [INFO]
