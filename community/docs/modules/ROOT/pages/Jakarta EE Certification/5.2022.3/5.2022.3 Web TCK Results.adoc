...
{empty} +
{empty} +
https://www.payara.fish/downloads/payara-platform-community-edition[Payara Server 5.2022.3 (Web Profile)]
|===
...
+
https://docs.payara.fish/community/docs/5.2022.3/jakartaee-certification/5.2022.3/tck-results-web-5.2022.3.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 692.804 s - in TestSuite
[INFO]
[INFO] Results:
[INFO]
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,511.902 s - in TestSuite
 [mvn.test] [INFO]
