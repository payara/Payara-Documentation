...
_cacerts.p12_: PKCS12 formatted file used as Trust Store file holding the X.509 certificates.
_keystore.p12_: PKCS12 formatted file containing the Cryptographic keys, like the private keys associated with the certificates.
