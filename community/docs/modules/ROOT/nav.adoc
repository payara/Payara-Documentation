...
.Technical Documentation
 ...
 Technical Documentation\Payara Server Documentation\Extensions\gRPC Support
 xref:Technical Documentation\Payara Server Documentation\Extensions\gRPC Support\Overview.adoc[Technical Documentation\Payara Server Documentation\Extensions\gRPC Support\Overview]
 xref:Technical Documentation\Payara Server Documentation\Extensions\gRPC Support\Usage.adoc[Technical Documentation\Payara Server Documentation\Extensions\gRPC Support\Usage]
