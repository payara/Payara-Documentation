...
***** xref:Technical Documentation/Ecosystem/Connector Suites/Cloud Connectors/Amazon SQS Versioning.adoc[Amazon SQS Versioning]
***** xref:Technical Documentation/Ecosystem/Connector Suites/Cloud Connectors/Amazon SQS with Amazon SSO.adoc[Amazon SQS with Amazon SSO]
