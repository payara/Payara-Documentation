...
|DCOM |xref:nodes.adoc#creating-listing-testing-and-deleting-dcom-nodes[Creating, Listing, Testing, and Deleting `DCOM` Nodes] + |xref:instances.adoc#administering-glassfish-server-instances-centrally[Administering GlassFish Server Instances Centrally] +

|SSH |xref:nodes.adoc#creating-listing-testing-and-deleting-ssh-nodes[Creating, Listing, Testing, and Deleting `SSH` Nodes] + |xref:instances.adoc#administering-glassfish-server-instances-centrally[Administering GlassFish Server Instances Centrally] +

|None |xref:nodes.adoc#creating-listing-and-deleting-config-nodes[Creating, Listing, and Deleting `CONFIG` Nodes] + |xref:instances.adoc#administering-glassfish-server-instances-locally[Administering GlassFish Server Instances Locally] +
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for creating a password alias, see the xref:reference-manual:create-password-alias.adoc#create-password-alias-1[`create-password-alias`] help page.
+
[source,shell]
----
...
* xref:reference-manual:create-password-alias.adoc#create-password-alias-1[`create-password-alias`(1)]
...
For information about all the options for configuring the node, see the xref:reference-manual:validate-dcom.adoc#validate-dcom-1[`validate-dcom`(1)] help page.
+
[source,shell]
----
...
* xref:reference-manual:asadmin.adoc#asadmin-1m[`asadmin`(1M)]
* xref:reference-manual:validate-dcom.adoc#validate-dcom-1[`validate-dcom`(1)]
...
key, see the xref:docs:reference-manual:setup-ssh.adoc#setup-ssh-1[`setup-ssh`(1)] help page.
+
[source,shell]
----
...
* xref:ssh-setup.adoc#setting-up-the-mks-toolkit-on-windows[Setting Up the MKS Toolkit on Windows]
* xref:ssh-setup.adoc#setting-up-ssh-on-unix-and-linux-systems[Setting Up SSH on UNIX and Linux Systems]
* xref:docs:reference-manual:setup-ssh.adoc#setup-ssh-1[`setup-ssh`(1)]
...
* xref:reference-manual:asadmin.adoc#asadmin-1m[`asadmin`(1M)]
* xref:reference-manual:create-password-alias.adoc#create-password-alias-1[`create-password-alias`(1)]
* xref:reference-manual:setup-ssh.adoc#setup-ssh-1[`setup-ssh`(1)]
...
+
NOTE: Only the options that are required to complete this task are provided in
this step. For information about all the options for creating a passwordalias, see the xref:reference-manual:create-password-alias.adoc#create-password-alias-1[`create-password-alias`(1)] help page.
+
[source,shell]
----
asadmin> create-password-alias alias-name
...
installation of Payara Server software, see the xref:reference-manual:install-node-dcom.adoc#install-node-dcom-1[`install-node-dcom`(1)] help page.
+
[source,shell]
----
...
* xref:reference-manual:install-node-dcom.adoc#install-node-dcom-1[`install-node-dcom`(1)]
* xref:reference-manual:install-node-ssh.adoc#install-node-ssh-1[`install-node-ssh`(1)]
...
Server software, see the xref:reference-manual:uninstall-node-dcom.adoc#uninstall-node-dcom-1[`uninstall-node-dcom`(1)] help page.
...
+
NOTE: Only the options that are required to complete this task are provided in this step. For information about all the options for removing Payara
Server software, see the xref:reference-manual:uninstall-node-ssh.adoc#uninstall-node-ssh-1[`uninstall-node-ssh`(1)] help page.
...
* xref:reference-manual:uninstall-node-dcom.adoc#uninstall-node-dcom-1[`uninstall-node-dcom`(1)]
* xref:reference-manual:uninstall-node-ssh.adoc#uninstall-node-ssh-1[`uninstall-node-ssh`(1)]
