...
*  xref:dd-elements.adoc#gihzx[About Application Deployment]
*  xref:dd-elements.adoc#giphm[About Assembly and Deployment Events]
*  xref:dd-elements.adoc#giifh[About Deployment Tools]
*  xref:dd-elements.adoc#gipud[Additional Information on Application Deployment]
...
GlassFish Server deployment tools are described in  xref:dd-elements.adoc#giifh[About
Deployment Tools].

The following topics are addressed here:

*  xref:dd-elements.adoc#giptw[General Deployment Functionality]
*  xref:dd-elements.adoc#gihzc[Deployment Descriptors and Annotations]
*  xref:dd-elements.adoc#gikhs[Modules and Applications]
*  .xref:dd-elements.adocgijla[Access to Shared Framework Classes]
*  .xref:dd-elements.adocgihzk[Naming Standards]
*  .xref:dd-elements.adocgkhhv[Module and Application Versions]
...
options. See  .xref:dd-elements.adocbeaee[JSR 88 Client] and link:#giiel[JSR 88 Naming].
