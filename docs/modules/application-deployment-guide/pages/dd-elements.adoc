...
xref:dd-elements.adoc#glassfish-application[`glassfish-application`] (`glassfish-application.xml`)
...
xref:dd-elements.adoc#glassfish-application[`glassfish-application`] (`glassfish-application.xml`),
xref:dd-elements.adoc#glassfish-ejb-ja[`glassfish-ejb-jar`] (`glassfish-ejb-jar.xml`)
...
matching succeeds. Overrides the same attribute in a
 xref:dd-elements.adoc#beasf[`constraint-field-value`] subelement.
...
xref:dd-elements.adoc#glassfish-web-app[`glassfish-web-app`] (`glassfish-web.xml`),
xref:dd-elements.adoc#ava-web-start-access[`java-web-start-access`] (`glassfish-application-client.xml`)
...
xref:dd-elements#cmp-resource[`cmp-resource`] (`glassfish-ejb-jar.xml`)
...
xref:dd-elements.adoc#bearv[`cmp-resource`], xref:dd-elements.adoc#mdb-connection-factory[`mdb-connection-factory`]
...
xref:dd-elements.adoc#property-with-attributes[`property` (with attributes)], xref:dd-elements.adoc#gikqk[`valve`]
(`glassfish-web.xml`); xref:dd-elements.adoc#beaqs[`activation-config`],
...
xref:dd-elements.adoc#connector-connection-pool[`connector-connection-pool`],
xref:dd-elements.adoc#connector-resource[`connector-resource`], xref:dd-elements.adoc#giyhr[`custom-resource`],
xref:dd-elements.adoc#external-jndi-resource[`external-jndi-resource`],
xref:dd-elements.adoc#jdbc-connection-pool[`jdbc-connection-pool`], xref:dd-elements.adoc#giyhm[`jdbc-resource`],
...
a| xref:dd-elements.adoc#jms-max-messages-loa[`jms-max-messages-load`]
|zero or one
...
a| xref:dd-elements.adoc#jb-ref-name[`ejb-ref-name`]
|only one
...
xref:dd-elements.adoc#ransport-config[`transport-config`] (`glassfish-ejb-jar.xml`)
...
xref:dd-elements.adoc#beayh[`transport-config`] (`glassfish-ejb-jar.xml`)
...
xref:dd-elements.adoc#giyiy[`resources`] (`glassfish-resources.xml`)
...
a| xref:dd-elements.adoc#[`service-ref`]
|zero or more
|Specifies runtime settings for a web service reference.
...
This is the root element; there can only be one `glassfish-ejb-jar` element in a `glassfish-ejb-jar.xml` file. See xref:dd-elements.adoc#the-glassfish-ejb-jar.xml-file[The glassfish-ejb-jar.xml File].
...
a| xref:dd-elements.adoc#[`resource-env-ref`]
|zero or more
|Maps the absolute JNDI name to the `resource-env-ref` in the corresponding Jakarta EE XML file.
...
a| xref:dd-elements.adoc#[`description`]
|zero or one
|Contains a text description of this element.
...
xref:dd-elements.adoc#[`ejb`] (`glassfish-ejb-jar.xml`)
...
xref:dd-elements.adoc#locale-charset-inf0[`locale-charset-info`] (`glassfish-web.xml`)
...
xref:dd-elements.adoc#[`session-manager`] element is `memory`.
...
xref:dd-elements.adoc#[`message-security`] (`glassfish-web.xml`, `glassfish-ejb-jar.xml`, `glassfish-application-client.xml`)
...
xref:dd-elements.adoc#[`locale-charset-info`], xref:dd-elements.adoc#[`glassfish-web-app`] (`glassfish-web.xml`)
...
xref:dd-elements.adoc#external-jndi-resource[`external-jndi-resource`],
xref:dd-elements.adoc#jdbc-connection-poo[`jdbc-connection-pool`], xref:dd-elements.adoc#jdbc-resource[`jdbc-resource`],
...
xref:dd-elements.adoc#enterprise-beans[`enterprise-beans`], xref:dd-elements.adoc#[`cmp-resource`],
...
xref:dd-elements.adoc#glassfish-application[`glassfish-application`] (`glassfish-application.xml`), xref:dd-elements.adoc#as-context[`as-context`],  xref:dd-elements.adoc#login-config[`login-config`] (`glassfish-ejb-jar.xml`)
...
a| xref:dd-elements.adoc#admin-object-resourc[`admin-object-resource`]
|zero or more
|Defines an administered object for an inbound resource adapter.
...
See "xref:docs:application-development-guide:container_managed-persistence.adoc#automatic-database-schema-capture[Automatic Database Schema Capture]" in GlassFish Server Open Source Edition Application Development Guide.
...
Specifies the name of a database table. The table must be present in the database schema file. See " See xref:docs:application-deployment-guide:application-development-guide:container_managed-persistence.adoc#automatic-database-schema-capture[Automatic Database Schema Capture]" in Payara Server Open Source Edition Application Development Guide.
...
Specifies a custom valve for this web application. You can define a valve for all the web applications on a specific virtual server. For details, see xref:docs:application-deployment-guide:reference-manual:create-virtual-server.adoc#create-virtual-server[`create-virtual-server`].
...
This is different from a xref:dd-elements.adoc#[`security-map`], which maps the principal received during servlet or EJB authentication to the credentials accepted by the EIS.
