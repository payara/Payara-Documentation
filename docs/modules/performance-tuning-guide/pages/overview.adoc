...
See the xref:docs:ha-administration-guide:overview.adoc[Payara Server High
...
* For details on profiling, see "xref:docs:application-development-guide:setting-up-dev-env.adoc#profiling-tools[Profiling Tools]" in Payara Server Application Development Guide. http://www.youtube.com/watch?v=FavsE2pzAjc[Payara Server - Performance Tuner demo] (`http://www.youtube.com/watch?v=FavsE2pzAjc`).
