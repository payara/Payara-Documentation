...
this release of the Payara Server Open Source Edition 5.0 software.
...
deployment subcommands, see the link:../application-deployment-guide/toc.html#GSDPG[Payara Server Open Source
...
link:../reference-manual/toc.html#GSRFM[Payara Server Open Source Edition Reference Manual] also
...
link:../reference-manual/list-modules.html#GSRFM00185[`list-modules`]::
  Lists modules that are accessible to the Payara Server subsystem.
...
link:../reference-manual/start-database.html#GSRFM00234[`start-database`]::
  ...
  working with applications deployed to the Payara Server. For
...
link:../reference-manual/version.html#GSRFM00261[`version`]::
  ...
  information in this guide, see
  link:general-administration.html#ghhox[To Display the Payara Server
  Version].
...
link:../reference-manual/generate-jvm-report.html#GSRFM00138[`generate-jvm-report`]::
  ...
  virtual machine that runs Payara Server. For procedural information
...
link:../reference-manual/list-jvm-options.html#GSRFM00180[`list-jvm-options`]::
  ...
  launcher when Payara Server is started. Supported in remote mode
  only. For procedural information in this guide, see
...
link:../reference-manual/list-loggers.html#GSRFM869[`list-loggers`]::
  Lists all public loggers in your distribution of Payara Server Open
...
link:../reference-manual/monitor.html#GSRFM00212[`monitor`]::
  Displays monitoring information for the common Payara Server
