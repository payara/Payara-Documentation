...
= Administering Concurrent Resources
This chapter provides procedures for administering concurrent resources in the Payara Server environment by using the `asadmin` command-line
utility.
...
capabilities to Java EE applications. In Payara Server, you configure
...
specific Payara Server resources. For concurrent resources, the
...
xref:docs:reference-manual:create-context-service.adoc[`create-context-service`] subcommand.
...
xref:docs:reference-manual:list-context-services.adoc[`list-context-services`] subcommand.
...
xref:docs:reference-manual:delete-context-services.adoc[`delete-context-service`] subcommand.
...
included with Payara Server, see +
...
xref:docs:reference-manual:create-managed-thread-factory.adoc[`create-managed-thread-factory`] subcommand.
. If necessary, notify users that the new resource has been created.
...
xref:docs:reference-manual:list-managed-thread-factory.adoc[`list-managed-thread-factories`] subcommand.
...
xref:docs:reference-manual:delete-managed-thread-factory.adoc[`delete-managed-thread-factory`] subcommand.
...
included with Payara Server, see  xref:docs:administration-guide:concurrent.adoc#default-concurrent-resources[Default Concurrent Resources].
...
xref:docs:reference-manual:create-managed-executor-service.adoc[`create-managed-executor-service`] subcommand.
. If necessary, notify users that the new resource has been created.
...
xref:docs:reference-manual:list-managed-executor-services.adoc[`list-managed-executor-services`] subcommand.
...
xref:docs:reference-manual:delete-managed-executor-services.adoc[`delete-managed-executor-service`] subcommand.
...
service resource included with Payara Server, see
xref:docs:administration-guide:concurrent.adoc#default-concurrent-resources[Default Concurrent Resources].
...
xref:docs:reference-manual:create-managed-scheduled-executor-services.adoc[`create-managed-scheduled-executor-service`]
subcommand.
. If necessary, notify users that the new resource has been created.
...
xref:docs:reference-manual:list-managed-scheduled-executor-services.adoc[`list-managed-scheduled-executor-services`] subcommand.
...
Remote subcommands require a running server.
. List the managed scheduled executor service resources by using the
xref:docs:reference-manual:list-managed-scheduled-executor-services.adoc[`list-managed-scheduled-executor-service`] subcommand.
...
xref:docs:reference-manual:delete-managed-scheduled-executor-services.adoc[`delete-managed-scheduled-executor-service`]
subcommand.
