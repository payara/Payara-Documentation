...
. Create the connector connection pool by using the xref:docs:reference-manual:create-connector-connection-pool.adoc[`create-connector-connection-pool`] subcommand. Information about properties for the subcommand is included in this help page.
...
. List existing connector connection pools by using the xref:docs:reference-manual:list-connector-connection-pools.adoc[`list-connector-connection-pools`] subcommand.

. List the security maps for a specific connector connection pool by using the xref:docs:reference-manual:list-connector-security-maps.adoc[`list-connector-security-maps`] subcommand.
...
. List existing connector security maps by using the xref:docs:reference-manual:list-connector-security-maps.adoc[`list-connector-security-maps`] subcommand.

. Modify a security map for a specific connector connection pool by using the xref:docs:reference-manual:update-connector-security-map.adoc[`update-connector-security-map`] subcommand.
...
. Ensure that the server is running. Remote subcommands require a running server.
. List existing connector connection pools by using the xref:docs:reference-manual:list-connector-connection-pools.adoc[`list-connector-connection-pools`] subcommand.
. Delete a security map for a specific connector connection pool by xref:docs:reference-manual:delete-connector-security-map.adoc[`delete-connector-security-map`] subcommand. Information about options for this subcommand is included in this help
page.
+
