...
. Delete the connector connection pool by using the xref:docs:reference-manual:delete-connector-connection-pools.adoc[`delete-connector-connection-pool`] subcommand.
...
. Delete the connector resource by using the xref:docs:reference-manual:delete-connector-resources.adoc[`delete-connector-resource`] subcommand.
...
. List the configurations for a resource adapter by using the xref:docs:reference-manual:list-resource-adapter-config.adoc[`list-resource-adapter-configs`] subcommand.
...
Before creating a connector work security map, you must first create a connector connection pool. For instructions, see xref:docs:administration-guide:connectors.adoc[To Create a Connector Connection Pool].
...
. List the connector work security maps by using the xref:docs:reference-manual:list-connector-work-security-map.adoc[`list-connector-work-security-maps`] subcommand.
