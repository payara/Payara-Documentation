...
Payara Server includes the JavaMail API along with JavaMail service providers that allow an application component to send email notifications over the Internet and to read email from IMAP and POP3 mail servers.
...
. Create a JavaMail resource by using the xref:docs:reference-manual:create-javamail-resources.adoc[`create-javamail-resource` #f#] subcommand. Information about the properties for the subcommand is included in this help page.
. To apply your changes, restart Payara Server. See xref:docs:administration-guide:javamail.adoc[To Restart a Domain #f#].
...
. Ensure that the server is running. Remote subcommands require a running server.
. List the JavaMail resources by using the xref:docs:reference-manual:list-javamail-resources.adoc[`list-javamail-resources` #f#] subcommand.
...
. To apply your changes, restart Payara Server. xref:docs:administration-guide:domains.adoc[To Restart a Domain].
