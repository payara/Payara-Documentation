...
. Create a JavaMail resource by using the xref:docs:reference-manual:create-javamail-resources.adoc[`create-javamail-resource`] subcommand. Information about the properties for the subcommand is included in this help page.
