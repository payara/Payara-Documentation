...
HTTP Server for load balancing with Payara Server 5.0 refer to xref:docs:ha-administration-guide:http-load-balancing.adoc#configuring-http-load-balancing[Configuring HTTP Load Balancing] in Payara Server
