...
see "xref:docs:application-deployment-guide:dd-files.adoc#the-glassfish-ejb-jar.xml-file[The glassfish-ejb-jar.xml File]" in Payara Server Open Source Edition Application Deployment Guide.
...
see "xref:docs:application-deployment-guide:dd-files.adoc#the-sun-cmp-mappings.xml-file[The sun-cmp-mappings.xml File]" in Payara Server Open Source Edition Application Deployment Guide.
...
and "xref:docs:application-deployment-guide:dd-elements.adoc#fetched-with[fetched-with]" in Payara Server Open Source Edition Application Deployment Guide.
...
(Recursive prefetching is not supported, because it does not usually enhance performance.) See "xref:docs:application-deployment-guide:dd-elements.adoc#fetched-with[fetched-with]" in Payara Server Open Source Edition Application Deployment Guide.

To disable prefetching for specific custom finders, use the `prefetch-disabled` element in the `glassfish-ejb-jar.xml` file.
See "xref:docs:application-deployment-guide:dd-elements.adoc#prefetch-disabled[prefetch-disabled]" in Payara Server Open Source Edition Application Deployment Guide.
