...
To configure the AWS Secrets Cloud Config Source from the command line, use the `set-aws-config-source-configuration` asadmin command. Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/set-aws-config-source-configuration.adoc#set-aws-config-source-configuration[`set-aws-config-source-configuration`] for detailed information.

Also, you can retrieve the current configuration for the AWS Config Source using the `get-aws-config-source-configuration` asadmin command. Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/get-aws-config-source-configuration.adoc#get-aws-config-source-configuration[`get-aws-config-source-configuration`] for detailed information.
