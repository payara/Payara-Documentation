...
|`cloud`
|180
|Reads configuration properties from various Cloud provider secret stores. You can find out more about our supported cloud config sources here: xref:documentation/microprofile/config/cloud/Overview.adoc[Cloud Config Sources]
