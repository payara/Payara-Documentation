...
Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/set-fault-tolerance-configuration.adoc#set-fault-tolerance-configuration[`set-fault-tolerance-configuration`] for detailed information.
...
----
Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/get-fault-tolerance-configuration.adoc#get-fault-tolerance-configuration[`get-fault-tolerance-configuration`] for detailed information.
