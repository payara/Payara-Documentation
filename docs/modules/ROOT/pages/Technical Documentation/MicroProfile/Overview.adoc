...
* https://github.com/eclipse/microprofile-config/releases/tag/3.0[Config 3.0]
* https://github.com/eclipse/microprofile-metrics/releases/tag/4.0[Metrics 4.0]
* https://github.com/eclipse/microprofile-health/releases/tag/4.0[Health Check 4.0]
* https://github.com/eclipse/microprofile-fault-tolerance/releases/tag/4.0[Fault Tolerance 4.0]
* https://github.com/eclipse/microprofile-jwt-auth/releases/tag/2.0[JWT Authentication 2.0]
* https://github.com/eclipse/microprofile-opentracing/releases/tag/3.0[OpenTracing 3.0]
* https://github.com/eclipse/microprofile-open-api/releases/tag/3.0[OpenAPI 3.0]
* https://github.com/eclipse/microprofile-rest-client/releases/tag/3.0[Rest Client 3.0]
