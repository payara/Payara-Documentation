...
For more information see the documentation for the xref:Technical Documentation/Payara Server Documentation/Server Configuration And Management/Application Deployment/Descriptor Elements.adoc#jaxrs-roles-allowed-enabled[jaxrs-roles-allowed-enabled] element.
