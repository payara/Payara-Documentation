...
Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/set-openapi-configuration.adoc#set-openapi-configuration[`set-openapi-configuration`] for detailed information.
...
Refer xref:Technical Documentation/Payara Server Documentation/Command Reference/get-openapi-configuration.adoc#get-openapi-configuration[`get-openapi-configuration`] for detailed information.
