...
in a `glassfish-web.xml` and `payara-web.xml` file. See xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-files.adoc#the-glassfish-web.xml-file[The glassfish-web.xml File].
...
This is the root element; there can only be one `resources` element in a `glassfish-resources.xml` and `payara-resources.xml` file. See xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-files.adoc#the-glassfish-resources.xml-file[The glassfish-resources.xml File].
