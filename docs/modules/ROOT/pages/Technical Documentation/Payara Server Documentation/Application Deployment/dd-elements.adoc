...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#jdbc-connection-pool[`jdbc-connection-pool`], xref:jdbc-resource[`jdbc-resource`],
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#clustered-attach-postconstruct[`clustered-attach-postconstruct`]
|zero or one
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#clustered-bean[`clustered-bean`]
|zero or one
|Defines whether the bean is treated as a clustered singleton.

a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#clustered-detach-predestroy[`clustered-detach-predestroy`]
|zero or one
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#clustered-key-name[`clustered-key-name`]
|zero or one
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#clustered-lock-type[`clustered-lock-type`]
|zero or one
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#classloading-delegate[`classloading-delegate`]
|zero or one
|Configures classloading delegation for the enterprise application.

a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#enable-implicit-cdi[`enable-implicit-cdi`]
|zero or one
|Enables implicit CDI bean scanning for the enterprise archive.

a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#scanning-exclude-and-scanning-include[`scanning-include`]
|zero or one
|Includes third party JAR files for CDI scanning using pattern matching.

a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#scanning-exclude-and-scanning-include[`scanning-exclude`]
|zero or one
|Excludes third party JAR files for CDI scanning using pattern matching.

a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#whitelist-package[`whitelist-package`]
|zero or one
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#webservice-default-login-config[`webservice-default-login-config`]
|zero or one
...
See xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-files.adoc#the-glassfish-web.xml-file[The glassfish-web.xml and payara-web.xml Files].
...
a| xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#jaxrs-roles-allowed-enabled[`jaxrs-roles-allowed-enabled`]
|zero or one
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#glassfish-web-app[`glassfish-web-app`/`payara-web-app`] (`glassfish-web.xml` and `payara-web.xml`)
...
See xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-files.adoc#the-glassfish-resources.xml-file[The glassfish-resources.xml and payara-resources Files].
...
See "xref:Technical Documentation/Application Development/container_managed-persistence.adoc#automatic-database-schema-capture[Automatic Database Schema Capture]" in the Payara Server Application Development section.
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#glassfish-application[`glassfish-application`] (`glassfish-application.xml`),
xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc#glassfish-web-app[`glassfish-web-app` or `payara-web-app`] (`glassfish-web.xml`)
