...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` and `payara-web.xml`)
...
Defines Payara Server specific configuration for a web module. This is the root element; there can only be one `glassfish-web-app`/`payara-web-app` element in a `glassfish-web.xml`/`payara-web.xml` file.
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#payara-web-app[`glassfish-web-app`] (`glassfish-web.xml` and `payara-web.xml`)
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#payara-web-app[`payara-web-app`] instead. Specifies information about the application's internationalization settings.
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#locale-charset-info[`locale-charset-info`], xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#payara-web-app[`payara-web-app`] (`glassfish-web.xml` and `payara-web.xml`)
