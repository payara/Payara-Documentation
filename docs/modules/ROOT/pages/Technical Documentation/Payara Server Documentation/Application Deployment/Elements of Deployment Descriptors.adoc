...
See xref:Technical Documentation/Payara Server Documentation/Application Deployment/Deployment Descriptor Files.adoc#the-payara-web.xml-file[The payara-web.xml File].
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#locale-charset-info[`locale-charset-info`], xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#payara-web-app[`payara-web-app`] (`payara-web.xml`)
...
See xref:Technical Documentation/Payara Server Documentation/Application Deployment/Deployment Descriptor Files.adoc#the-payara-resources.xml-file[The payara-resources File].
