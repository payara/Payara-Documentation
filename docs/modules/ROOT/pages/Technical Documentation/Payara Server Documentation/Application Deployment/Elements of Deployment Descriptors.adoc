...
`glassfish-application-client.xml`); xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#ejb[`ejb`], xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#mdb-connection-factory[`mdb-connection-factory`] (`glassfish-ejb-jar.xml`)
...
xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#java-method[`java-method`] (`glassfish-web.xml` (deprecated) and `payara-web.xml`, `glassfish-ejb-jar.xml`, `glassfish-application-client.xml`); xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#method[`method`] (`glassfish-ejb-jar.xml`)
