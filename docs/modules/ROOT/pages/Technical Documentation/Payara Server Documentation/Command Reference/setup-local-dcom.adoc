...
command, ensure that items in the Windows operating system are set as described in "xref:Technical Documentation/Payara Server Documentation/High Availability/ssh-setup.adoc#windows-operating-system-settings[Windows Operating System Settings]" in the Payara Server High Availability section.
...
* "xref:Technical Documentation/Payara Server Documentation/High Availability/ssh-setup.adoc#windows-operating-system-settings[Windows Operating System Settings]" in the Payara Server High Availability section
