...
* xref:Technical Documentation/Payara Server Documentation/General Administration/jdbc.adoc#administering-database-connectivity[Administering Database Connectivity] in Payara Server General Administration section
