...
* "xref:ROOT:Technical Documentation/Application Development/lifecycle-listeners.adoc#developing-lifecycle-listeners[Developing Lifecycle Listeners]" in the Payara Server Application Development section
