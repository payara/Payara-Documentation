...
Removes a system property of the domain, configuration, or server instance, one at a time.
...
The `delete-system-property` subcommand deletes a system property of a domain, configuration, or server instance. Make sure that the
