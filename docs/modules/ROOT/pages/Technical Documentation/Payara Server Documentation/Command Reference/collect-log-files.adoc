...
* xref:Technical Documentation/Payara Server Documentation/General Administration/logging.adoc[Administering the Logging Service] in Payara Server General Administration section
