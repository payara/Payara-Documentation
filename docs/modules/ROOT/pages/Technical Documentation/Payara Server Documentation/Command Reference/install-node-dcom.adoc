...
`--installdir`::
  The absolute path to the parent of the base installation directory where the Payara Server software is to be installed on each host, for example, `C:\payara7`. If the directory does not exist, the subcommand creates the directory. +
...
....................................
WROTE FILE TO REMOTE SYSTEM: C:/payara7/glassfish_install.zip and C:/payara7/unpack.bat
Output from Windows Unpacker:
 
C:\Windows\system32>C:
 
C:\Windows\system32>cd "C:\payara7"
 
C:\payara7>jar xvf glassfish_install.zip
