...
`--type`::
  ...
  For more information about these directories, see xref:ROOT:Technical Documentation/Application Development/class-loaders.adoc#class-loaders[Class Loaders] in the Payara Server Application section.
