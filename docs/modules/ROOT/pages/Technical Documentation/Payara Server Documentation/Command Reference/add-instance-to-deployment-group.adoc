...
This command will only work with standalone instances (see xref:Technical Documentation/Payara Server Documentation/High Availability/instances.adoc#types-of-payara-server-instances[here] for more information).
