...
documented on the xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Request Tracing Service/Request Tracing Service.adoc[corresponding section]
