...
Tracing in the Payara Platform is done either automatically, by using the MicroProfile OpenTracing `@Traced`
annotation or by utilizing OpenTelemetry APIs. This section covers manually decorating your applications for tracing.
