...
separate log file. More information on the Log Notifier can be found on the xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notification Service.adoc#log-notifier[the Log Notifier section] of the Notification Service overview.
...
xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notification Service.adoc#log-notifier[the Log Notifier].
<<<<<<< HEAD
