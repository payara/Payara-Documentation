...
If the xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notification Service.adoc#log-notifier[Log Notifier] is enabled, such events will be presented in the server's log file like in the following sample:
...
active notifiers, both the xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notification Service.adoc#notification-service[Notification Service] and each respective notifier must be enabled first.
...
TIP: You can find the list of available notifiers using the xref:/Technical Documentation/Payara Server Documentation/Logging and Monitoring/Notification Service/Notification Service.adoc#list-notifiers[`list-notifiers`] command.
