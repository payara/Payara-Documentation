...
<build>
    ...
    <plugins>
        <plugin>
            ...
            <configuration>
                <protocArtifact>com.google.protobuf:protoc:4.35.0:exe:${os.detected.classifier}</protocArtifact>
...
[source, log]
----
[#|2022-03-02T14:15:10.947-0600|INFO|Payara 7|jakarta.enterprise.system.container.web.com.sun.web.security|_ThreadID=118;_ThreadName=http-thread-pool::http-listener-1(2);_TimeMillis=1646252110947;_LevelValue=800;|
  Context path from ServletContext:  differs from path from bundle: /|#]

[#|2022-03-02T14:15:10.990-0600|INFO|Payara 7|fish.payara.samples.grpc.PayaraService|_ThreadID=234;_ThreadName=grpc-default-executor-0;_TimeMillis=1646252110990;_LevelValue=800;|
