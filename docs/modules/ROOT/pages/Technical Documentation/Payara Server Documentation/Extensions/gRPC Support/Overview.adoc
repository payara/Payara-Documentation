...
gRPC support is bundled with Payara Server Enterprise, Payara Micro Enterprise, and the Payara Embedded distributions. No separate installation is required. The `grpc-support.jar` module is automatically included in `glassfish/modules`.
