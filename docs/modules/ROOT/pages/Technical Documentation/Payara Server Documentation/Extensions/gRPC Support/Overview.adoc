...
gRPC is a modern open-source high performance Remote Procedure Call (RPC) framework that use HTTP2 and simplifies the communication with protocol
buffers to share data between client and server. By enabling gRPC Payara Server gives more options to create binary adaptable services. gRPC comes
 bundled with Payara Server Enterprise Edition and can be used to create gRPC services in your web applications.
