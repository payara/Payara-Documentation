...
Payara Server Enterprise includes a special notifier to send notifications from the Notification service to an organisation's domain channel using Slack API integrations.
