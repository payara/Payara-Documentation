...
"xref:ROOT:Technical Documentation/Payara Server Documentation/High Availability/instances.adoc#administering-payara-server-instances[Administering Payara Server Instances]" in
...
For more information about virtual servers, see xref:Technical Documentation/Payara Server Documentation/General Administration/http_https.adoc#administering-virtual-servers[Administering Virtual Servers].
...
see xref:ROOT:Technical Documentation/Payara Server Documentation/Security Guide/system-security.adoc#to-change-an-administration-password[To Change an Administration Password] in Payara Server Security Guide.
...
For more information, see xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-create-a-domain[To Create a Domain].
...
* xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-create-a-domain[`To Create a Domain`]
...
asadmin list-domains
----
. Log in to the domain by using the xref:Technical Documentation/Payara Server Documentation/General Administration/asadmin-subcommands.adoc#domain-subcommands[`login`] command.
...
information about passwords, see xref:ROOT:Technical Documentation/Payara Server Documentation/Security Guide/system-security.adoc#administering-passwords[Administering Passwords] in Payara Server Security Guide.
...
If needed, see xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-stop-a-domain[To Stop a Domain].
...
xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-list-domains[To List Domains]. +
...
as described in xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-stop-a-domain[To Stop a Domain].
...
xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-back-up-a-domain[To Back Up a Domain]. You can automatically maintain a
...
xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-migrate-the-das[To Migrate the DAS].
...
See xref:ROOT:Technical Documentation/Payara Server Documentation/High Availability/ssh-setup.adoc#enabling-centralized-administration-of-payara-server-instances[Enabling Centralized Administration of Payara Server Instances] in the Payara Server High Availability section for instructions.
