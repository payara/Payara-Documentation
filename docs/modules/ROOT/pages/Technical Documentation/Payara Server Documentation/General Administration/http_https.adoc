...
Some virtual server properties can be set for a specific web application. For details, see "xref:Technical Documentation/Payara Server Documentation/Application Deployment/dd-elements.adoc[payara-web-app]" in the Payara Server Application Deployment section.
