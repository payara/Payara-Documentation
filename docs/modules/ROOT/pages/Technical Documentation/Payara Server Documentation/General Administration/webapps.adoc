...
balancing with Payara Server refer to xref:docs:ROOT:Technical Documentation/Payara Server Documentation/High Availability/http-load-balancing.adoc#configuring-http-load-balancing[Configuring HTTP Load Balancing] in the Payara Server High Availability section.
