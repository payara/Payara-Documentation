...
* xref:Technical Documentation/Payara Server Documentation/General Administration/http_https.adoc#configure-an-http-listener-for-ssl[To Configure an HTTP Listener for SSL]
