...
See xref:Technical Documentation/Payara Server Documentation/General Administration/monitoring.adoc#enable-jmx[enable JMX Monitoring] for how to view all available MBeans.
