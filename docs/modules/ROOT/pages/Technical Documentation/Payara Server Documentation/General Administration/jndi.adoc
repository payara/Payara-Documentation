...
* xref:Technical Documentation/Payara Server Documentation/General Administration/jndi.adoc#administering-custom-jndi-resources[Administering Custom JNDI Resources]
* xref:Technical Documentation/Payara Server Documentation/General Administration/jndi.adoc#administering-external-jndi-resources[Administering External JNDI Resources]
...
Information on properties for the subcommand is contained in this help page. Restart Payara Server. See xref:Technical Documentation/Payara Server Documentation/General Administration/domains.adoc#to-restart-a-domain[To Restart a Domain].
