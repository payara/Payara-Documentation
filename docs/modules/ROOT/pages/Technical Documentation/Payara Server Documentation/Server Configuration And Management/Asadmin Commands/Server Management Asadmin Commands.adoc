...
|===
|Options | Type | Description | Default | Mandatory
|`--timeout` |`Integer` |Specifies how long to take for the domains to restart in seconds. If restarting the domains takes longer than this amount then this command will fail |`60` |No
|===
...
|`--timeout` |`Integer` |Specifies how long to take for the domains to stop in seconds. If stopping the domains takes longer than this amount then this command will fail |`60` |No
|====
