...
|Setting Name |Value
|Pool Name |test-pool
|Resource Type |`jakarta.sql.DataSource`
...
[source, shell]
----
asadmin> create-jdbc-connection-pool --datasourceclassname com.mysql.jdbc.jdbc2.optional.MysqlDataSource --restype jakarta.sql.DataSource --property user=root:password=test:DatabaseName=test:ServerName=localhost:port=3306 test-pool
----
...
[source, log]
----
[#|2016-02-04T18:51:01.467+0000|FINE|Payara 6.2022.1|jakarta.enterprise.resource.sqltrace.com.sun.gjc.util|_ThreadID=35;_ThreadName=http-listener-1(5);_TimeMillis=1454611861467;_LevelValue=500;ClassName=com.sun.gjc.util.SQLTraceLogger;MethodName=sqlTrace;|
...
<jdbc-connection-pool name="examplePool"
        res-type="jakarta.sql.DataSource"
...
[source, shell]
----
asadmin create jdbc-connection-pool --datasourceclassname org.h2.jdbcx.JdbcDataSource --restype jakarta.sql.XADataSource --logjdbccalls=true examplePool
----
