...
* In `payara-expression-config.properties` file _[Since Payara Server 5.2020.2]_.
...
NOTE: Environment variable substitution in the logging properties file is available since Payara Server _5.184_
