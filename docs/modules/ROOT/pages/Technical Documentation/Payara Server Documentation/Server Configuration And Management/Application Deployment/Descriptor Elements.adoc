...
xref:/Technical Documentation/Payara Server Documentation/Server Configuration And Management/Classloading.adoc[Enhanced Class loading] section.
...
Used to whitelist packages on xref:/Technical Documentation/Payara Server Documentation/Server Configuration And Management/Classloading.adoc#extreme-classloading-isolation[*extreme class loading isolation*].
...
Payara Server Community, see the
xref:/Technical Documentation/Payara Server Documentation/Server Configuration And Management/Classloading.adoc[Enhanced Classloading] section.
