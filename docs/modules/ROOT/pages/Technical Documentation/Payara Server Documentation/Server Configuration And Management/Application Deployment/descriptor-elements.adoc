...
xref:/Technical Documentation/Payara Server Documentation/classloading.adoc[Enhanced Class loading] section.
...
Whether this bean should be a xref:/Technical Documentation/Payara Server Documentation/Public API/clustered-singleton.adoc[Clustered Singleton]. Can be applied only to singleton EJBs.
...
Used to whitelist packages on xref:/Technical Documentation/Payara Server Documentation/classloading.adoc#extreme-classloading-isolation[*extreme class loading isolation*].
...
Payara Server Community, see the
xref:/Technical Documentation/Payara Server Documentation/classloading.adoc[Enhanced Classloading] section.
...
For more detail, see the xref:/Technical Documentation/Payara Server Documentation/ejb/Overview.adoc[Enhanced EJB configuration] section.
