...
For more information about configuring connection factories, see "xref:docs:Application Development:jms.adoc#administering-jms-connection-factories-and-destinations[Administering JMS Connection Factories and Destinations]" in the Payara Server Administration section. For more information about MDBs, see "xref:ROOT:Technical Documentation/Application Development/ejb.adoc#using-message-driven-beans[Using Message-Driven Beans]" in the Payara Server Application Development section.
