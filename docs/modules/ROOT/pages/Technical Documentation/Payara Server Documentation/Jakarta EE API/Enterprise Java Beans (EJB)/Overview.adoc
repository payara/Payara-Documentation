...
import static jakarta.naming.Context.PROVIDER_URL;
...
+
* `jakarta.naming.Context.SECURITY_PRINCIPAL` for the username
* `jakarta.naming.Context.SECURITY_CREDENTIALS` for the password
...
import static jakarta.naming.Context.INITIAL_CONTEXT_FACTORY;
import static jakarta.naming.Context.PROVIDER_URL;
import static jakarta.naming.Context.SECURITY_CREDENTIALS;
import static jakarta.naming.Context.SECURITY_PRINCIPAL;
import java.util.Properties;
import jakarta.naming.Context;
import jakarta.naming.InitialContext;
public class RemoteEJBLiteClient{
...
| Instance of `jakarta.net.ssl.SSLContext` or a `String` representing its fully qualified classname.
...
| Instance of a `jakarta.net.ssl.HostnameVerifier` or a `String` representing its fully qualified classname.
...
The JNDI customization options listed above as well the environment variables defined in `jakarta.naming.Context` (except `APPLET`) can be set by setting a system property of the same name that will act as a fallback.
