...
See xref:Technical Documentation/Payara Server Documentation/High Availability/ssh-setup.adoc[Enabling Centralized Administration of Payara Server Instances] for more information.
