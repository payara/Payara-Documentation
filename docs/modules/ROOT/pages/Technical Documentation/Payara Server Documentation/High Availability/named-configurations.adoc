...
For more information, see xref:Technical Documentation/Payara Server Documentation/High Availability/instances.adoc#types-of-payara-server-instances[Types of Payara Server Instances].
...
* xref:Technical Documentation/Payara Server Documentation/High Availability/clusters.adoc#to-create-a-cluster[To Create a Cluster]
...
For information about how to copy a configuration, see xref:Technical Documentation/Payara Server Documentation/High Availability/named-configurations.adoc#to-create-a-named-configuration[To Create a Named Configuration].
...
* xref:Technical Documentation/Payara Server Documentation/High Availability/clusters.adoc#to-delete-a-cluster[To Delete a Cluster]
...
property-name::
  The name of the property that you are modifying. For a list of available properties, see xref:Technical Documentation/Payara Server Documentation/High Availability/named-configurations.adoc#properties-for-port-numbers-in-a-named-configuration[Properties for Port Numbers in a Named Configuration].
...
port-property::
  The name of the property that corresponds to the port number that you are modifying. For a list of available properties, see xref:Technical Documentation/Payara Server Documentation/High Availability/named-configurations.adoc#properties-for-port-numbers-in-a-named-configuration[Properties for Port Numbers in a Named Configuration].
