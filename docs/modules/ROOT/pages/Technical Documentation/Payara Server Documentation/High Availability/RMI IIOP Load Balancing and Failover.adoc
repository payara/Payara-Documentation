...
* Your deployment has a deployment group of at least two instances.
* Jakarta EE applications are deployed to all instances within the deployment group.
* The instances within the deployment group utilize a Hazelcast instance group that is not shared with any instance outside of the deployment group
