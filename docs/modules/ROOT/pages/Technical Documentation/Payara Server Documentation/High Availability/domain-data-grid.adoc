...
|Data Grid Discovery Mode | See xref:Technical Documentation/Payara Server Documentation/High Availability/domain-data-grid.adoc#domain-discovery-mode[Discovery Modes]
|====
...
|Enabled | See xref:Technical Documentation/Payara Server Documentation/High Availability/domain-data-grid.adoc#enabling-and-disabling-the-data-grid[Disabling Data Grid] for detailed information
...
* xref:Technical Documentation/Payara Server Documentation/High Availability/deployment-groups.adoc[Deployment Groups],
