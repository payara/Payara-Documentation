...
| The name of the xref:Technical Documentation/Payara Server Documentation/High Availability/deployment-groups.adoc[Deployment Group] that the instance should join.
