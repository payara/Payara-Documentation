...
[IMPORTANT]
====
Distributed Component Object Model (DCOM) remote protocol support has been deprecated and as such may not function as intended. DCOM support has been removed in Azul Payara Server 5.89.0 and 6.40.0, and Payara Platform Community Edition 7 onwards..
