...
xref:/Technical Documentation/Ecosystem/Payara AI Agent.adoc[Payara AI Agent]::
An intelligent assistant for Payara Server that lets developers query, diagnose, and administer a running server using plain English.
