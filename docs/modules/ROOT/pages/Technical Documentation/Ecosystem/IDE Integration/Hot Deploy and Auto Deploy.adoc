...
* Apache Netbeans:
** xref:Technical Documentation/Ecosystem/IDE Integration/NetBeans Plugin/Payara Server.adoc#hot-deploy-and-auto-deploy-settings[Payara Server]
** xref:Technical Documentation/Ecosystem/IDE Integration/NetBeans Plugin/Payara Micro.adoc#hot-deploy-and-auto-deploy-settings[Payara Micro]
