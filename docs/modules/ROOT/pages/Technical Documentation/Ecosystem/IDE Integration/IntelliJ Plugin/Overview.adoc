...
* xref:Technical Documentation/Ecosystem/IDE Integration/IntelliJ Plugin/Payara Starter.adoc[Payara Starter] - Generate new Jakarta EE projects targeting either Payara Server or Payara Micro directly from the IntelliJ IDEA New Project wizard.
...
* xref:Technical Documentation/Ecosystem/IDE Integration/IntelliJ Plugin/Payara Micro.adoc[Payara Micro] - The Payara IntelliJ Ultimate Tools provide support to run and debug Payara Micro applications from IntelliJ IDEA. Payara Micro is the microservices-ready version of the Payara Server.
