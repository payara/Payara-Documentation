...
If you are developing an application on IntelliJ IDEA Community Edition, then install Payara Micro Tools which is also  available in the https://plugins.jetbrains.com/plugin/15445-payara-micro-community-tools[JetBrains Plugins Marketplace].
