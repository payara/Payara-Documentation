...
image::vscode-extension/payara-server/deploy-application.png[alt=Deploy application]

Alternatively, an application can be deployed from *Java Projects* interface:

image::vscode-extension/payara-server/java-projects-deploy.png[alt=Deploy application]

The deployed application can be opened in the browser, undeployed or disabled by right-clicking on the application:

image::vscode-extension/payara-server/list-application.png[alt=Open application homepage]
