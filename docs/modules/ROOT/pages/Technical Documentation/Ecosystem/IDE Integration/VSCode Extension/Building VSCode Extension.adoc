...
The Payara Tools VS Code IDE Extension sourcecode is available in the https://github.com/payara/ecosystem-vscode-plugin[VS Code Extension repository].
...
You must first clone the repository where the extension sourcecode is stored. https://github.com/payara/ecosystem-vscode-plugin[VS Code Extension repository]
