...
For information about web services security, see xref:Technical Documentation/application-development-guide:securing-apps.adoc#configuring-message-security-for-web-services[Configuring Message Security for Web Services].
