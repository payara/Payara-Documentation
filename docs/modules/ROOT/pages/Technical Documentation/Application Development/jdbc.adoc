...
More information on how to configure SQL Trace listeners can be read in the xref:Technical Documentation/Payara Server Documentation/General Administration/jdbc.adoc[JDBC Connection Pool] configuration of Payara Server's administration section.
...
For general information about connections and JDBC URLs, see "xref:Technical Documentation/Payara Server Documentation/General Administration/jdbc.adoc#administering-database-connectivity[Administering Database Connectivity]" in the Payara Server General Administration section.
