...
For more information about the JNDI API, see xref:Technical Documentation/Application Development/jndi.adoc#using-a-custom-jndi.properties-file[Using the Java Naming and Directory Interface].
