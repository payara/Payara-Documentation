...
If one or more of the beans in the module are manually mapped, and you use any of the `asadmin deploy` options, the deployment is not harmed in any way, but the options have no effect, and a warning is written to the server log.
