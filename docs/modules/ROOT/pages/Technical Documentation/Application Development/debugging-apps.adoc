...
Payara Server debugging is based on JPDA. For more information, see xref:Technical Documentation/application-development-guide:debugging-apps.adoc#jpda-options[JPDA Options].
...
. To add JPDA options, add any desired JPDA debugging options in Debug Options. See xref:Technical Documentation/application-development-guide:debugging-apps.adoc#jpda-options[JPDA Options].
...
For more information about the `asadmin generate-jvm-report` command, see the xref:Technical Documentation/Payara Server Documentation/Command Reference/generate-jvm-report.adoc[generate-jvm-report].
...
xref:Technical Documentation/application-development-guide:debugging-apps.adoc#jpda-options[JPDA Options].
...
NOTE: The Application Client Container is supported only in the Full Profile, not in the Web Profile. See xref:Technical Documentation/application-development-guide:java-clients.adoc#developing-java-clients[Developing Java Clients].
...
NOTE: JMS resources are supported only in the Full Profile, not in the Web Profile. See xref:Technical Documentation/application-development-guide:jms.adoc#using-jakarta-messaging[Using Jakarta Messaging].
...
To send Payara Server messages to the standard console instead of `stderr`, start the domain in verbose mode as described in xref:Technical Documentation/application-development-guide:debugging-apps.adoc#enabling-verbose-mode[Enabling Verbose Mode].
