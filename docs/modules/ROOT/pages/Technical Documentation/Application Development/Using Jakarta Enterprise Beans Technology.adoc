...
If you wish to trace the client itself you must set up and use a third-party tracer such as ZipKin or Jaeger. +
Details on setting these up can be found xref:Technical Documentation/MicroProfile/OpenTracing.adoc#alternative-implementation[here].
