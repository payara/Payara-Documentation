...
`true`. See xref:default-fetch-group-flags[Default Fetch Group Flags] and "xref:Technical Documentation/Payara Server Documentation/Application Deployment/Elements of Deployment Descriptors.adoc#fetched-with[fetched-with]" in the Payara Server Application Deployment section.
