...
The Request Tracing service works the same on Payara Micro and will trace the same events described in its xref:Technical Documentation/Application Development/Request Tracing.adoc#request-tracing[documentation].
