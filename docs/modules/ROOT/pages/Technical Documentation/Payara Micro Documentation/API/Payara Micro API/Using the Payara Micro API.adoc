...
It is possible to execute administration commands programmatically using the xref:/Technical Documentation/Payara Micro Documentation/API/Payara Micro API/Micro API.adoc[Payara Micro API], using the `PayaraMicroRuntime.run` method.
