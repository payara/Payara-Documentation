...
It is possible to execute administration commands programmatically using the xref:/documentation/payara-micro/appendices/micro-api.adoc[Payara Micro API], using the `PayaraMicroRuntime.run` method.
