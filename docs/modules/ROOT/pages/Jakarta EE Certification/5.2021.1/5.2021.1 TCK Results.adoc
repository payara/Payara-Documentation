...
**Payara Server 5.2021.1 Full Profile Certification Summary**
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 682.044 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,995.369 s - in TestSuite
 [mvn.test] [INFO] 
