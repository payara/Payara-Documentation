...
For more information about Coherence*Web, see http://download.oracle.com/docs/cd/E18686_01/coh.37/e18690/glassfish.html[Using Coherence*Web with GlassFish Server] (`http://docs.oracle.com/cd/E18686_01/coh.37/e18690/glassfish.html`).
...
* xref:docs:deployment-planning-guide:planning.adoc#planning-your-availability[Planning for Availability]
. Size your system. For more information, see link:planning.html#abfdg[Design Decisions].
...
For more information, see "xref:docs:ha-administration-guide:ssh-setup.adoc#setting-up-ssh-for-centralized-administration[Setting Up SSH for Centralized Administration]" in Payara Server Open Source Edition High Availability Administration Guide.
