...
* xref:delete-protocol-finder.adoc#delete-protocol-finder-1[`delete-protocol-finder`(1)],
* xref:list-protocol-finders.adoc#list-protocol-finders-1[`list-protocol-finders`(1)]
