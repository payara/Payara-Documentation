...
`--installdir`::
  The full path to the parent of the base installation directory of the \{product---name} software on the host, for example, `C:\glassfish3`.
...
The parent of the base installation directory of the \{product---name} software on this host is `C:\middleware\glassfish3`.
...
* xref:delete-node-dcom.adoc#delete-node-dcom-1[`delete-node-dcom`(1)],
