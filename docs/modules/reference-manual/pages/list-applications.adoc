...
* xref:list-sub-components.adoc#list-sub-components-1[`list-sub-components`(1)],
* xref:show-component-status.adoc#show-component-status-1[`show-component-status`(1)]
