...
application's deployment descriptor. Instead, use the xref:set-web-context-param.adoc#set-web-context-param[`set-web-context-param`(1)] subcommand for this purpose.
