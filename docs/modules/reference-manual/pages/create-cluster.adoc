...
Payara Server instances are running on the same host. +
    ...
    ** port is the port number of the port on which the instance listens for messages from GMS. The system property
    ...
    "xref:docs:ha-administration-guide:clusters.adoc#discovering-a-cluster-when-multicast-transport-is-unavailable[Discovering a Cluster When Multicast Transport Is Unavailable]" in Payara Server High Availability Administration Guide.
...
Unavailable]" in Payara Server High Availability Administration Guide.
...
* "xref:ha-administration-guide:clusters.adoc#discovering-a-cluster-when-multicast-transport-is-unavailable[Discovering a Cluster When Multicast Transport Is Unavailable]" in Payara Server High Availability Administration Guide
