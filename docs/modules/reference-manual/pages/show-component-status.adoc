...
component-name::
  ...
  application versions, see "xref:docs:application-deployment-guide:overview.adoc#module-and-application-versions[Module and Application Versions]" in GlassFish Server Open Source Edition Application Deployment Guide.
...
* xref:../application-deployment-guide/toc.adoc#GSDPG[GlassFish Server Open Source Edition Application Deployment
Guide]
