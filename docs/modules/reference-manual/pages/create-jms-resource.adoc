...
`--property`::
  ...
  Additionally, you can specify `connector-connection-pool` attributes as connector resource properties. For a list of these attributes, see "xref:docs:application-deployment-guide:dd-elements.adoc#connector-connection-pool[connector-connection-pool]" in Payara Server Application Deployment Guide. +
