...
`--property`::
  ...
  For a list of these attributes, see "xref:docs:application-deployment-guide:dd-elements.adoc#connector-connection-pool[connector-connection-pool]" in Payara Server Open Source Edition Application Deployment Guide. +
