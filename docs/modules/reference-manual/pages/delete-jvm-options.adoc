...
The `delete-jvm-options` subcommand removes one or more command-line options for the Java application launcher. These options are removed
from the Java configuration `java—config` element or the profiler `profiler` element of the `domain.xml` file. To see the Java application
launcher options that can be deleted, use the xref:list-jvm-options.adoc#list-jvm-options-1[`list-jvm-options`(1)] subcommand.
...
* xref:create-jvm-options.html#create-jvm-options-1[`create-jvm-options`(1)],
* xref:list-jvm-options.html#list-jvm-options-1[`list-jvm-options`(1)],
* xref:restart-domain.html#restart-domain-1[`restart-domain`(1)]
