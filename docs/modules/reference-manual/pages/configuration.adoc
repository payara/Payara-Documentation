...
* xref:dotted-names.adoc#dotted-names-5asc[`dotted-names`(5ASC)]
* "xref:docs:administration-guide/overview.adoc#GSADG00527[Configuration Tasks]" in Payara Server Open Source
