...
However, you may use xref:stop-local-instance.adoc#stop-local-instance-1[`stop-local-instance`(1)]
or xref:stop-instance.adoc#stop-instance-1[`stop-instance`(1)] to stop the instances.
...
* xref:delete-local-instance.adoc#delete-local-instance-1[`delete-local-instance`(1)],
* xref:delete-node-config.adoc#delete-node-config-1[`delete-node-config`(1)],
* xref:install-node.adoc#install-node-1[`install-node`(1)],
* xref:install-node-dcom.adoc#install-node-dcom-1[`install-node-dcom`(1)],
...
* xref:uninstall-node-dcom.adoc#uninstall-node-dcom-1[`uninstall-node-dcom`(1)],
* xref:uninstall-node-ssh.adoc#uninstall-node-ssh-1[`uninstall-node-ssh`(1)],
* xref:update-node-config.adoc#update-node-config-1[`update-node-config`(1)],
